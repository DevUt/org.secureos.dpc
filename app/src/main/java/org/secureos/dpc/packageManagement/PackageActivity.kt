...
class PackageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val unBannablePackageList = PackageData(this,PackageManager.MATCH_DISABLED_COMPONENTS,true).unBannableList()
        ...
        packageRecyclerView.adapter = ItemAdapter(packageList,
            PackagePrefManager(this),packageManager , unBannablePackageList)
